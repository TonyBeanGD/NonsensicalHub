...
namespace TonyBeanTools
{
    public class ComponentModifier : EditorWindow
    {
        ...
        {
            public static readonly string[] components = new string[] { "Button", "Font" };
        ...
        private void OnGUI()
        {
            ...
            CompontentModifierPanel.choiceComponent = EditorGUILayout.Popup("选择组件", CompontentModifierPanel.choiceComponent, new string[] { "Button", "Font" });
