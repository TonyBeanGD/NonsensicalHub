...
namespace NonsensicalKit.Utility
{
    public static class VectorHelper
    {
        ...
        public static PointF3 TransformWithPos(this Matrix4x4 matrix4X4, PointF3 pos)
        {
            Vector3 newPos = matrix4X4 * new Vector4(pos.x, pos.y, pos.z, 1);
            return new PointF3(newPos);
        }
        ...
        public static PointF3 GetEightPosF3(int pos, float size)
        {
            switch (pos)
            {
                case 0: return new PointF3(size, size, size);
                case 1: return new PointF3(size, size, -size);
                case 2: return new PointF3(size, -size, size);
                case 3: return new PointF3(size, -size, -size);
                case 4: return new PointF3(-size, size, size);
                case 5: return new PointF3(-size, size, -size);
                case 6: return new PointF3(-size, -size, size);
                case 7: return new PointF3(-size, -size, -size);
                default: return PointF3.zero;
            }
        }
    }
}
