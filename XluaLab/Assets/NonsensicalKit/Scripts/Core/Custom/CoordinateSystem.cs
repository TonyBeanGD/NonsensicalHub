...
namespace NonsensicalKit.Custom
{
    ...
    public struct CoordinateSystem
    {
        ...
        /// <returns></returns>
        public PointF3 GetCoordinate(Vector3 worldPos)
        {
            ...
            PointF3 Point1Value = new PointF3(x_dir * x_distance, y_dir * y_distance, z_dir * z_distance);
        ...
        /// <returns></returns>
        public Vector3 GetWorldPos(PointF3 value)
        {
            return origin + right * value.x + up * value.y + forward * value.z;
        }
        ...
        /// <returns></returns>
        public PointF3 CoordinateSystemTransform(CoordinateSystem targetCoordinateSystem, PointF3 targetPointValue)
        {
            Vector3 point2_World = targetCoordinateSystem.origin + targetPointValue.x * targetCoordinateSystem.right +
                targetPointValue.y * targetCoordinateSystem.up + targetPointValue.z * targetCoordinateSystem.forward;
