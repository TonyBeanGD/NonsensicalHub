...
namespace Assets.Sources.Core.Network
{
    public class HttpClient
    {
        ...
        public void SendAsync(HttpRequest httpRequest, Action<HttpResponse> responseHandler)
        {
            ...
            {
                case HttpMethod.Get:
                    NonsensicalKit.NonsensicalUnityInstance.Instance.StartCoroutine(Get(httpRequest.Url, httpRequest.Parameters, responseHandler));
                    break;
                case HttpMethod.Post:
                    NonsensicalKit.NonsensicalUnityInstance.Instance.StartCoroutine(Post(httpRequest.Url, httpRequest.Parameters, responseHandler));
                    break;
                default:
