    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                //Console.WriteLine("请输入算式（仅支持加减乘除）");

                //double d = Calculation(Console.ReadLine());
        ...
        /// <param name="_s"></param>
        /// <returns></returns>
        private static double Calculation(string _s)
        {
